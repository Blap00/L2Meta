...
SECRET_KEY = 'django-insecure-^a!k-a7d1k!g(fd!nwy9$*u+#e!g!++*(yg0nto_g%fo#^s^&0'
...
WSGI_APPLICATION = 'L2MetaNews.wsgi.application'
...
MEDIA_URL = '/uploads/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'news/static/storage/uploads')
